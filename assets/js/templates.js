export const Templates = {
  home() {
    ...
    <section class="hero home-hero container">
      ...
      <figure>
        <img src="assets/img/voluntarios.jpg" alt="Voluntários em atividade com crianças" width="1200" height="800" fetchpriority="high" decoding="async">
      </figure>
    </section>
  ...
  projetos() {
    return `
    <section class="container section" aria-labelledby="titulo-projetos">
      <header class="projects-header">
        <h2 id="titulo-projetos">Projetos Ativos</h2>
        <div class="filters">
          <label for="buscaProjetos" class="sr-only">Buscar projetos</label>
          <input id="buscaProjetos" class="input" type="search" placeholder="Buscar projetos" aria-label="Buscar projetos">
          <span class="tag on" data-cat="" role="button" tabindex="0" aria-pressed="true">Todos</span>
          <span class="tag" data-cat="educacao" role="button" tabindex="0" aria-pressed="false">Educação</span>
          <span class="tag" data-cat="tecnologia" role="button" tabindex="0" aria-pressed="false">Tecnologia</span>
        </div>
      </header>
      ...
      <div class="card-grid" style="margin-top: var(--space-16)">
        <article class="card" id="reforco" data-cat="educacao">
          <div class="card-media">
            <img src="assets/img/projeto-criancas.jpg" alt="Crianças estudando em reforço escolar" width="900" height="600" loading="lazy" decoding="async">
          </div>
          <div class="card-body">
        ...
        <article class="card" id="tecnologia" data-cat="tecnologia">
          <div class="card-media">
            <img src="assets/img/criancas-no-lab.jpg" alt="Adolescentes em laboratório de informática" width="900" height="600" loading="lazy" decoding="async">
          </div>
          <div class="card-body">
    ...
    <div class="modal-backdrop" id="modalProjeto" aria-hidden="true">
  ...
  cadastro() {
    return `
    <section class="container section signup" aria-labelledby="titulo-cadastro">
      <header><h2 id="titulo-cadastro">Cadastro de Voluntário</h2></header>
      ...
      <form class="form" id="formVoluntario" novalidate>
        <fieldset class="fieldset">
          ...
          <div class="field">
            ...
            <input class="input" type="text" id="nome" name="nome" required minlength="3" placeholder="Seu nome completo" autocomplete="name">
          </div>
          <div class="field">
            <label class="label" for="email">E-mail *</label>
            <input class="input" type="email" id="email" name="email" required placeholder="voce@email.com" autocomplete="email">
          </div>
          <div class="field">
            <label class="label" for="cpf">CPF *</label>
            <input class="input" type="text" id="cpf" name="cpf" required inputmode="numeric" maxlength="14" placeholder="000.000.000-00" aria-describedby="hint-cpf">
            <small id="hint-cpf" class="muted">Formato: 000.000.000-00</small>
          </div>
          <div class="field">
            <label class="label" for="telefone">Telefone / WhatsApp *</label>
            <input class="input" type="tel" id="telefone" name="telefone" required maxlength="15" placeholder="(11) 91234-5678" autocomplete="tel">
          </div>
          <div class="field">
        ...
        <fieldset class="fieldset">
          ...
          <div class="field">
            ...
            <input class="input" type="text" id="endereco" name="endereco" required placeholder="Rua Exemplo, 123" autocomplete="street-address">
          </div>
          <div class="row">
            <div class="col-md-6">
              <div class="field">
                <label class="label" for="cep">CEP *</label>
                <input class="input" type="text" id="cep" name="cep" required inputmode="numeric" maxlength="9" placeholder="00000-000" autocomplete="postal-code">
              </div>
            </div>
            <div class="col-md-4">
              <div class="field">
                <label class="label" for="cidade">Cidade *</label>
                <input class="input" type="text" id="cidade" name="cidade" required placeholder="São Paulo" autocomplete="address-level2">
              </div>
            </div>
            <div class="col-md-2">
              <div class="field">
                <label class="label" for="estado">UF *</label>
                <input class="input" type="text" id="estado" name="estado" required minlength="2" maxlength="2" placeholder="SP" autocomplete="address-level1">
              </div>
            </div>
          </div>
        </fieldset>
